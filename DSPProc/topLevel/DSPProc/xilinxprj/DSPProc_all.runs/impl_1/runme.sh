...
HD_PWD='E:/BE_Project/Project/Project_files/DSPProc/topLevel/DSPProc/xilinxprj/DSPProc_all.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSPProc_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSPProc_design_wrapper.tcl -notrace
