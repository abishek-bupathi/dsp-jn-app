...
HD_PWD='E:/BE_Project/Project/Project_files/DSPProc/topLevel/DSPProc/xilinxprj/DSPProc_all.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSPProc_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSPProc_design_wrapper.tcl
